...
import { getUserTudus, postCollection } from '../actions/AppActions'
...
const AddCollection = () => {
    ...
    return (
        <LinearGradient start={{ x: -0.2, y: 0 }} end={{ x: 1, y: 1 }} colors={['rgba(241, 65, 74, 0.3)', 'rgba(125, 88, 137, 0.3)', 'rgba(6, 160, 129, 0.3)', 'rgba(220, 223, 229, 0)']} style={styles.homecontainer}>
            ...
            <Text style={{fontWeight: 'bold'}}>Créer une collection </Text>
            ...
            <TextInput onChangeText={(val) => setSelected(val)} mainColor="#ffff" buttonText="Titre" placeholder="Nom de la collection"/>
            {/* <SelectList 
