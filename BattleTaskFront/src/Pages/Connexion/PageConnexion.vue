<template>
  <div class="pageConnexion">
    ...
    <div class="ConnexionSectionContaneur">
      <div
        v-if="isDisplayedConnexion & !isDisplayedModification"
        class="ConnnexionSection"
      >
        ...
        <div class="ConnexionBottomSection">
          <div
            v-on:click="validate"
            class="BT_Valider_ToDoList"
            id="large_button"
          >
            <label id="label_Valider">Connexion</label>
          </div>
        </div>
      </div>
      <div v-if="isDisplayedInscription" class="InscriptionSection">
        <div class="ConnexionTopSection">
          ...
          <img
            v-on:click="displayConnexion"
            src="@/assets/img/close.svg"
            class="Inscription_BT_close"
          />
        </div>
        <div class="InscriptionForm">
          ...
          <div class="InscriptionErrorSection">
            <DisplayError
              ...
              text="Le mot de passe ne contient pas les caractérisques requise"
            />
            <DisplayError
              v-show="passwordDismatchError"
        ...
        <div class="InscriptionBottomSection">
          <div
            ...
            id="large_button"
          >
            <label id="label_Valider">Enregistrer</label>
          </div>
        </div>
      </div>
      <div
      ...
      >
        ...
        <span v-on:click="displayInscription" class="newAcount_BT"
          >Crée ton compte</span
        >
      </div>
...
.ConnexionBottomSection,
.InscriptionBottomSection {
  display: flex;
  flex-direction: row;
  align-items: center;
  justify-content: center;
